...
(function () {
    ...
    const PROJECTS = [
        { id:1,  src:'./image/image.png',    href:'https://gestion-finance.infinityfreeapp.com', title:'Gestion Financière',   description:'App complète avec tableau de bord admin, suivi des transactions, notifications temps réel et génération de reçus PDF.', technologies:['PHP','MySQL','Tailwind','JavaScript','API REST'], year:'2026', icon:'bx bx-line-chart' },
        { id:2,  src:'./image/MIEL.jpeg',    href:'https://app-boutique-miel.netlify.app',        title:'BON MIEL',             description:'Boutique apicole avec catalogue, panier dynamique et commandes envoyées directement sur WhatsApp  sans serveur.',         technologies:['HTML5','CSS3','JavaScript','LocalStorage'],    year:'2024', icon:'bx bx-shopping-bag' },
        { id:3,  src:'./image/quiz.png',     href:'https://app-quiz-damel.netlify.app/',           title:'Quiz Interactif',      description:'Quiz avec chronomètre, score en temps réel et animations de feedback. 100% JavaScript natif, zéro dépendance.',            technologies:['HTML5','CSS3','Tailwind','JavaScript'],        year:'2024', icon:'bx bx-target-lock' },
        { id:4,  src:'./image/todolist.jpeg',href:'https://stellular-praline-df37c1.netlify.app/', title:'TODO List App',         description:'Gestionnaire de tâches React.js avec composants réutilisables, hooks, filtres dynamiques et persistance.',                 technologies:['React.js','Tailwind','Hooks','LocalStorage'],  year:'2024', icon:'bx bx-list-check' },
        { id:5,  src:'./image/montre.jpeg',  href:'https://app-montre.netlify.app',                title:'Horloge Temps Réel',   description:'Horloge analogique et digitale synchronisée. Aiguilles animées via CSS transforms et setInterval. Pure vanilla.',          technologies:['HTML5','CSS3','JavaScript','setInterval'],     year:'2024', icon:'bx bx-time-five' },
        { id:6,  src:'./image/BOUFFE.jpeg',  href:'https://damitielieericouattara-rgb.github.io/restaurant/', title:'Dabalie De Babi', description:'Plateforme street food ivoirienne : catalogue, panier, suivi de commande. Front JS + back PHP / MySQL.',          technologies:['HTML5','CSS3','JavaScript','PHP','MySQL'],     year:'2024', icon:'bx bx-store-alt' },
        { id:7,  src:'./image/immobilier.jpeg', href:'https://immobilier-site.netlify.app/',       title:'Y Immobilier',          description:'Site vitrine immobilier : catalogue de biens animé, fiches détaillées avec prix et localisation, formulaire de demande.', technologies:['HTML5','CSS3','JavaScript','Responsive'],      year:'2025', icon:'bx bx-building-house' },
        { id:8,  src:'https://btp-site.netlify.app/assets/images/features-1.jpg', href:'https://btp-site.netlify.app', title:'Y BTP Immobilier', description:'Site vitrine BTP complet : planning, architecture, construction et aménagement intérieur. Galerie de projets filtrée.', technologies:['HTML5','CSS3','JavaScript','Responsive'], year:'2025', icon:'bx bx-building-house' },
        { id:9,  src:'https://location-vehicule.netlify.app/assets/header.png', href:'https://location-vehicule.netlify.app/', title:'Location de Véhicule', description:'Plateforme de location de voitures premium : catalogue filtrable, recherche par date et lieu, fiches détaillées avec tarifs.', technologies:['HTML5','CSS3','JavaScript','Responsive'], year:'2025', icon:'bx bx-car' },
        { id:10, src:'https://eightyeight-site.netlify.app/assets/gallery-1.png', href:'https://eightyeight-site.netlify.app/', title:'EightyEight Detailing', description:'Site vitrine automobile avec galerie interactive, sections services et présentation de marque pour une expérience fluide.', technologies:['HTML5','CSS3','JavaScript','Responsive'], year:'2025', icon:'bx bx-store' }
    ];
    ...
    /* ── Nettoyer les filtres existants (plus utilisés) ── */
    ...
    function buildSplitPanel() {
        ...
        filtered.forEach((proj, idx) => {
            ...
            text.innerHTML = `<div class="pf-row-title">${proj.title}</div><span class="pf-row-cat">${proj.year}</span>`;
